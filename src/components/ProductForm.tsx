...
import { X, Image as ImageIcon, Tag, Package, Zap, AlertCircle, Upload, ChevronUp, ChevronDown, Trash2, Plus } from "lucide-react";
...
export function ProductForm({ onClose, product }: ProductFormProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    category: product?.category || "Kits Completos",
    subcategory: product?.subcategory || CATEGORIES["Kits Completos" as keyof typeof CATEGORIES][0],
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <div className="bg-gradient-to-r from-purple-600/10 to-pink-600/10 rounded-xl p-3 border-2 border-purple-500/30 hover:border-purple-500/60 transition-all duration-300 focus-within:border-purple-500/80 focus-within:shadow-lg focus-within:shadow-purple-500/20">
                    <Input
                      type="text"
                      placeholder="SKU-001"
                      value={formData.sku}
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    className="w-full bg-gradient-to-r from-blue-600/10 to-cyan-600/10 border-2 border-blue-500/30 text-white rounded-xl p-3 font-semibold hover:border-blue-500/60 focus:border-blue-500/80 focus:shadow-lg focus:shadow-blue-500/20 transition-all cursor-pointer appearance-none"
                  >
